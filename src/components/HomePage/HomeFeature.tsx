      ...
      <div  className="features__content">
        <div  className="features__grid-container">
          ...
          <article  className="feature">
            <span  className="feature__icon icon">
              <svg viewBox="0 0 83 78" height="60px" xmlns="http://www.w3.org/2000/svg"  className="features__icon">
                <title>Computer and mobile icons</title>
                <desc>An icon of a desktop alongside another icon showing a mobile phone</desc>
            ...
            <h3  className="feature__title">Access your files, anywhere</h3>
          ...
          <article  className="feature">
            <span  className="feature__icon icon">
              <svg viewBox="0 0 70 88" height="60px" xmlns="http://www.w3.org/2000/svg"  className="features__icon">
                <title>Shield icon</title>
                <desc>An icon showing a shield with a check tick in the center</desc>
          ...
          <article  className="feature">
            <span  className="feature__icon icon">
              <svg viewBox="0 0 91 64" height="60px" xmlns="http://www.w3.org/2000/svg"  className="features__icon">
                <title>File icon</title>
                <desc>An icon with a folder and two sheets with text and a drawing</desc>
                <g fill="none" fill-rule="evenodd">
            ...
            <h3  className="feature__title">Store any type of file</h3>
            <p  className="feature__description">
